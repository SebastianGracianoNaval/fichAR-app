...
**fichAR Context:** Use Flutter ThemeData, ColorScheme, TextTheme. Palettes in `definiciones/FRONTEND.md` (CFG-042). Tokens: primario, secundario, acento, fondo, texto, error, advertencia. Apply to Flutter widgets (Material/Cupertino), not CSS.
