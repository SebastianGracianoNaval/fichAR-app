...
|-------------|-------------|------------------------|-----------|
| **A.5.1** | Políticas para la seguridad de la información | definiciones/SEGURIDAD.md, ROLES.md, CONFIGURACIONES.md | Documentación centralizada |
| **A.5.2** | Roles y responsabilidades | RLS, RBAC (admin, supervisor, empleado, auditor, integrity_viewer) | employees.role, políticas RLS |
...
| **A.8.10** | Information deletion | audit_logs inmutable; retención CFG-037 (10 años) | definiciones/CONFIGURACIONES.md, migraciones |
...
| **A.8.24** | Use of cryptography | Hash chain SHA-256, HASH_PEPPER, JWT (Supabase) | fichaje-hash.ts, definiciones/SEGURIDAD.md |
